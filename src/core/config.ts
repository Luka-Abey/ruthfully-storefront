...
export const SUPPORT_EMAIL = "luka.abeywickrama@hotmail.co.uk";
...
export const SOCIAL_MEDIA = [
  {
    ariaLabel: "facebook",
    href: "https://www.facebook.com/RuthPackhamArtist/",
    path: require("../images/facebook-icon.svg"),
  },
  {
    ariaLabel: "instagram",
    href: "https://www.instagram.com/ruthelizabethpackham/",
